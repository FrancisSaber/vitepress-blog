import{_ as s,o as n,c as a,N as l}from"./chunks/framework.2919e4b3.js";const C=JSON.parse('{"title":"通过gitbash配置快捷指令","description":"","frontmatter":{"title":"通过gitbash配置快捷指令","author":"Younglina","date":"2022-09-07","categories":["文档"],"tags":["小技巧"]},"headers":[],"relativePath":"write/docs/alias.md","lastUpdated":1682354236000}'),e={name:"write/docs/alias.md"},p=l(`<p>windows配置vscode gitbash<br> 在设置中添加</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&quot;terminal.integrated.profiles.windows&quot;: {</span></span>
